$(document).ready(function() {
  ...
  $('#setor').change(function() {
    ...
    options += '<option value="" selected disabled>Selecione o tipo</option>';
  ...
  $('#tipoProblema').change(function() {
    ...
    options += '<option value="" selected disabled>Selecione o problema</option>';
  ...
  $('#setorLocalSelect').change(function() {
    ...
    options += '<option value="" selected disabled>Selecione o local</option>';
